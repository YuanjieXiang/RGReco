...
from src.external.surya.detection.loader import DetectionModelLoader, InlineDetectionModelLoader
from src.external.surya.detection.parallel import FakeExecutor
from src.external.surya.detection.util import get_total_splits, split_image
from src.external.surya.detection.schema import TextDetectionResult
from src.external.surya.settings import settings
from src.external.surya.detection.heatmap import parallel_get_boxes, parallel_get_inline_boxes
