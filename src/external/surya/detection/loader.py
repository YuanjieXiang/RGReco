...
from src.external.surya.detection.processor import SegformerImageProcessor

from src.external.surya.detection.model.config import EfficientViTConfig
from src.external.surya.detection.model.encoderdecoder import EfficientViTForSemanticSegmentation
