...
from src.external.surya.common.util import clean_boxes, rescale_bbox
from src.external.surya.detection.affinity import get_vertical_lines
from src.external.surya.detection import TextDetectionResult
