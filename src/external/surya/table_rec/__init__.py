...
from src.external.surya.table_rec.schema import TableCell, TableRow, TableCol, TableResult
from src.external.surya.common.polygon import PolygonBox
from src.external.surya.settings import settings
from src.external.surya.table_rec.loader import TableRecModelLoader
from src.external.surya.table_rec.model.config import BOX_PROPERTIES, SPECIAL_TOKENS, BOX_DIM, CATEGORY_TO_ID, MERGE_KEYS, \
    MERGE_VALUES
from src.external.surya.table_rec.shaper import LabelShaper
