...
from src.external.surya.table_rec.model.config import SuryaTableRecConfig, SuryaTableRecDecoderConfig, DonutSwinTableRecConfig
from src.external.surya.table_rec.model.encoderdecoder import TableRecEncoderDecoderModel
from src.external.surya.table_rec.processor import SuryaTableRecProcessor
